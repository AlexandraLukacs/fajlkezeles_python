...
for i in range(0, len(string_lista), 1):
    ...
    """ eltávolítjuk a sorok végéről a sortörést """
    print(aktsor)
...
atlageletkor=feladatok_szemelyeklistaval.atlageletkor(szemelyek_lista)
print(atlageletkor)

nok=feladatok_szemelyeklistaval.nokszama(szemelyek_lista)
print(nok)